...
document.addEventListener("DOMContentLoaded", () => {
  console.log("ページ読み込み完了！");
    ...
    code += `<button class="headerButton" onclick="location.href='index.html'" style="color: rgb(185, 8, 8);">敵ステータス</button>`
    else
    code += `<button class="headerButton" onclick="location.href='../enemyStatusData/index.html'">敵ステータス</button>`
